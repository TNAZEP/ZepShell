...
// Horizontal top bar - Waybar-style layout
RowLayout {
    id: root
    ...
    function checkPopout(x: real): void {
        ...
        if (id === "statusIcons" && Config.bar.popouts.statusIcons) {
            ...
            if (!Config.bar.tray.compact || item.expanded) {
    ...
    Repeater {
        ...
        DelegateChooser {
            ...
            DelegateChoice {
                ...
                delegate: WrappedLoader {
                    sourceComponent: HorizontalWorkspaces {
                        screen: root.screen
                    }
                }
            }
            DelegateChoice {
                ...
                delegate: WrappedLoader {
                    sourceComponent: HorizontalActiveWindow {
                        bar: root
            ...
            DelegateChoice {
                roleValue: "tray"
                delegate: WrappedLoader {
                    sourceComponent: HorizontalTray {}
                }
            }
            DelegateChoice {
                roleValue: "clock"
            ...
            DelegateChoice {
                ...
                delegate: WrappedLoader {
                    sourceComponent: HorizontalStatusIcons {}
                }
            }
            DelegateChoice {
                roleValue: "power"
